...
Echo. ================ Communication with IVFR Server  ============ >>presults.txt
  Ping s2ssh.ivfr.de >> presults.txt
...
Echo. Veuillez envoyer à Inview ce  fichier créé S.V.P. pour faciliter le suivi de la performance de notre system  >>presults.txt
